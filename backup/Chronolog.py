...
if __name__ == '__main__':
    ...
    # Open db.json and refresh values.
        ...
        # TODO: Abbreviate next 11 lines
            ...
            for peer in PEERS:
                ...
                for worker in thisPeerWorkers:
                    ...
                    thisWorkerMegaHashHours = thisWorkerHistory.json()['data']['averageHashrate']
                    thisPeerMegaHashHours = thisPeerMegaHashHours + thisWorkerMegaHashHours
                dbjson['peers'][peer]['cumulativeMegaHashHours'] = dbjson['peers'][peer]['cumulativeMegaHashHours'] + thisPeerMegaHashHours
